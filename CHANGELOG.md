...
- use TinyGo 0.40.0 in release builds
...
- correct the metadata guide

## v0.16.0 (2025-12-05)

### Feat

- add metadata JSON schema file

## v0.15.10 (2025-11-30)

### Fix

- bump go-libwebp to remove deps

## v0.15.9 (2025-11-25)

### Fix

- migrate to fixed go-libwebp v2.3.1
